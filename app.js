...
function dragDrop(imagenUrl, procesadorDrag) {
    ...
    procesadorDrag.addEventListener('drop', function(event) {
        event.preventDefault();
        mostrarMensajeAñadidoCesta();
    });
    }

function mostrarMensajeAñadidoCesta() {
    const mensaje = document.createElement('div');
    mensaje.textContent = "Producto añadido a la cesta";
    ...
    mensaje.style.boxShadow = '0 0 10px rgba(0, 0, 0, 0.1)';
